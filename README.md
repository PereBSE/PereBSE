...
IT Support Technician in training with a strong interest in hardware, operating systems, networking, and troubleshooting.
...
To build a professional career in IT Support by developing practical skills and documenting real-world projects and technical labs.
...
These experiences strengthened my troubleshooting, customer service and communication skills, which I now apply to my IT Support career path.


## Coming Soon

This GitHub profile will gradually include:

- Hardware repair and upgrade projects
- Windows installation and configuration labs
...
Técnico de soporte IT en formación con especial interés en hardware, sistemas operativos, redes y resolución de incidencias.
...
Este perfil irá incorporando progresivamente:

- Proyectos de reparación y actualización de equipos
- Laboratorios de instalación y configuración de Windows
- Ejercicios de redes
